 ...
 *  displays it so that the mechanic can also see the reason of the issue in its data.
 * */
public class GraphActivity extends AppCompatActivity
{
    private final String LOG_TAG = GraphActivity.class.getSimpleName();
